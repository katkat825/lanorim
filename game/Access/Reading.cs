...
// Moved here from Game.Companion in the lanorim port: how long a line stays up is the player's
// speech-speed setting (Adjustments.Speed), and the companion is only one of the things it governs
