...
namespace Game.Access
{
    ...
    public sealed class Adjustments
    {
        ...
        // THE TWO DIALS THAT WENT WITH THE HANDS. The old build let you pick the DM's skin
        // tone and whether his hands and arms were shown at all. Lanorim is table-only - no room,
        // no hands (docs/ART_DIRECTION.md section 11) - so there is nothing for either to set.
        // Everything else on this page is about the player, not the fiction, and carries over.
