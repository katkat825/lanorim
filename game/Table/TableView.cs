...
// Lifted out of the abandoned Game.Room in the lanorim port - HARVEST_PLAN.md says to check
// TableView.cs for a reusable table framing, and this is it. The room is gone; the problem it
// solves is not. A card lying flat on a table is read at a grazing angle and its text squashes to
// half height, and that is as true of a table-only view as it was of a room.
